...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="{{ env('FAVICON_GH') }}">
    <link rel="shortcut icon" type="image/png" href="{{ env('FAVICON_GH') }}">
    <link rel="icon" sizes="16x16 32x32 64x64" href="{{ env('FAVICON_GH') }}">
    <link rel="icon" type="image/png" sizes="196x196" href="{{ env('FAVICON_GH') }}">
