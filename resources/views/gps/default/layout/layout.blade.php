...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" sizes="16x16 32x32 64x64 128x128 196x196" href="{{ url('favicon-A-G.ico') }}">
    <link rel="shortcut icon" type="image/jpeg" sizes="16x16 32x32 64x64 128x128 196x196" href="{{ url('alphabet-G.jpeg') }}">
...
{{--    <link rel="stylesheet" href="https://cdn.bootcss.com/bootstrap-fileinput/4.4.8/css/fileinput.min.css">--}}
    ...
    {{--layout-style--}}
    @include(env('TEMPLATE_GPS_DEF').'layout.layout-style')
...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_GPS_DEF').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_GPS_DEF').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_GPS_DEF').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_GPS_DEF').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_GPS_DEF').'layout.control-sidebar')
...
{{--layout-script--}}
@include(env('TEMPLATE_GPS_DEF').'layout.layout-script')
