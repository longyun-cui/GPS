...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{url('/admin')}}" class="logo hidden-xs _none">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        {{--<!-- Logo -->--}}
        <div class="navbar-custom-menu" style="height:50px;line-height:50px;float:left;padding-left:4px;margin-right:20px;">
            <a href="{{ url('/') }}">
