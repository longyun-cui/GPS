                ...
                <form action="" method="post" class="form-horizontal form-bordered" id="form-edit-item">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 ">
                                <select class="form-control" name="menu_id" id="select2-menu">
                                    @if($operate == 'edit' && $data->menu_id)
                                        <option data-id="{{ $data->menu_id or 0 }}" value="{{ $data->menu_id or 0 }}">{{ $data->menu_er->name }}</option>
                                    @else
    ...
    <script>
        $(function() {
            ...
            $("#edit-item-submit").on('click', function() {
                var options = {
                    url: "{{ url('/admin/item/todo-item-edit') }}",
                    type: "post",
                    dataType: "json",
                    // target: "#div2",
                    ...
                    success: function (data, status, xhr) {
                        ...
                        else
                        {
                            ...
                            location.href = "{{ url('/admin/item/todo-item-list') }}";
            ...
            $('#select2-menu').select2({
                ajax: {
                    url: "{{ url('/admin/item/todo-select2-menu') }}",
                    dataType: 'json',
                    delay: 250,
