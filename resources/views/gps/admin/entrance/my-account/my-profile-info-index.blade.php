        ...
        <div class="box box-info form-container">
            ...
            <div class="box-header with-border" style="margin: 15px 0;">
                ...
                <div class="pull-right">
                    <a href="{{url('/admin/my-account/my-profile-info-edit')}}">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
{{--                        <div><label class="control-label">{{ date("Y-m-d",$data->birth_day) }}</label></div>--}}
                        <div><label class="control-label">{{ $data->birth_day or '' }}</label></div>
                    </div>
                </div>
                {{--portrait--}}
