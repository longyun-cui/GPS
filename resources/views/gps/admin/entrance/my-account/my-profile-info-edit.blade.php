        ...
        <div class="box box-info form-container">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <input type="text" class="form-control date_picker" name="birth_day" placeholder="请选择生日" readonly="readonly"
{{--                               value="{{ date("Y-m-d",$data->birth_day) }}"--}}
                               value="{{ $data->birth_day or '' }}"
                        >
                    </div>
                </div>
...
<script>
    $(function() {
        ...
        $("#edit-info-submit").on('click', function() {
            var options = {
                url: "{{url('/admin/my-account/my-profile-info-edit')}}",
                type: "post",
                dataType: "json",
                // target: "#div2",
                success: function (data) {
                    ...
                    {
                        layer.msg(data.msg);
                        location.href = "{{url('/admin/my-account/my-profile-info-index')}}";
                    }
                }
            };
