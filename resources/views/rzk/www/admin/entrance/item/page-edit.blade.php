...
@section('head_title')
    {{ $title_text or '页面编辑' }} - 管理员系统 - {{ config('rzk.info.info.short_name') }}
@endsection
        ...
        <div class="box box-info form-container">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2"><sup class="text-red">*</sup> 页面标识</label>
                    <div class="col-md-8 ">
                        <input type="text" class="form-control" name="item_sign" placeholder="页面" value="{{ $data->item_sign or '' }}">
                    </div>
                </div>
            ...
            var options = {
                ...
                success: function (data) {
                    ...
                    else
                    {
                        ...
                        location.href = "{{ url('/admin/item/page-list') }}";
