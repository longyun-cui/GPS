...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" sizes="16x16 32x32 64x64 196x196" href="{{ url('favicon-A-G.ico') }}">
    <link rel="shortcut icon" type="image/jpeg" sizes="16x16 32x32 64x64 196x196" href="{{ url('alphabet-G.jpeg') }}">
