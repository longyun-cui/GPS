...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="{{ url('/resource/custom/zy/zy.ico') }}">
    <link rel="shortcut icon" type="image/png" href="{{ url('/resource/custom/zy/zy.jpg') }}">
    <link rel="icon" sizes="16x16 32x32 64x64" href="{{ url('/resource/custom/zy/zy.ico') }}">
    <link rel="icon" type="image/png" sizes="196x196" href="{{ url('/resource/custom/zy/zy.jpg') }}">
...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_ZY_STAFF').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_ZY_STAFF').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_ZY_STAFF').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_ZY_STAFF').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_ZY_STAFF').'layout.control-sidebar')
...
@include(env('TEMPLATE_ZY_STAFF').'layout.layout-script')
