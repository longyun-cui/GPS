...
//            window.location.href = "/statistic/statistic-user?id="+that.attr('data-id');
        ...
        // 显示【修改密码】
        $("#item-main-body").on('click', ".item-password-change-show", function() {
            var that = $(this);
        ...
        // 【修改密码】取消
        $("#modal-password-body").on('click', "#item-password-change-cancel", function() {
            $('input[name=id]').val('');
            $('input[name=user-password]').val('');
            $('input[name=user-password-confirm]').val('');
        ...
        // 【修改密码】提交
        $("#modal-password-body").on('click', "#item-password-change-submit", function() {
            var that = $(this);
            layer.msg('确定"修改"么', {
                time: 0
                ,btn: ['确定', '取消']
        ...
        // 【重置密码】提交
        $("#modal-password-body").on('click', "#item-password-reset-submit", function() {
            var that = $(this);
            layer.msg('确定"重置"么', {
                time: 0
                ,btn: ['确定', '取消']
