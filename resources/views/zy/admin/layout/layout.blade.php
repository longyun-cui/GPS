...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_ZY_ADMIN').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_ZY_ADMIN').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_ZY_ADMIN').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_ZY_ADMIN').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_ZY_ADMIN').'layout.control-sidebar')
