@extends(env('TEMPLATE_GPS_DEV_UI').'layout.layout')


@section('head_title')
    {{ $title_text or "GPS/Dev/UI" }}
@endsection
                                ...
                                <a href="{{ url('/product-detail?id=123') }}">
                                    <li class="item">
                                        <div class="product-img">
                                            <div class="image-box">
                                                <img src="{{ url('/custom/gh/images/slider/1.jpg') }}" alt="Product Image">
                                            </div>
                                        </div>
                                ...
                                <a class="zoom- clearfix" target="_blank" href="http://www.piano-lai.com/item/2944">
                                    <div class="item-container model-left-right padding-8px bg-grey-f5">
                                        ...
                                        <figure class="image-container padding-top-1-4-">
                                            <div class="image-box">
                                                <img data-action="zoom-" src="http://cdn.piano-lai.com/research/common/2023-07-06/64a623d1c764d1688609745.jpg" alt="Property Image">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 item-col">
                                <a class="zoom- clearfix" target="_blank" href="http://www.piano-lai.com/item/2943">
                                    <div class="item-container model-left-right padding-8px bg-grey-f5">
                                        ...
                                        <figure class="image-container padding-top-1-4-">
                                            <div class="image-box">
                                                <img data-action="zoom-" src="http://cdn.piano-lai.com/research/common/2023-07-06/64a623c1513871688609729.jpg" alt="Property Image">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 item-col">
                                <a class="zoom- clearfix" target="_blank" href="http://www.piano-lai.com/item/2942">
                                    <div class="item-container model-left-right padding-8px bg-grey-f5">
                                        ...
                                        <figure class="image-container padding-top-1-4-">
                                            <div class="image-box">
                                                <img data-action="zoom-" src="http://cdn.piano-lai.com/research/common/2023-07-06/64a623b0737a61688609712.jpg" alt="Property Image">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 item-col">
                                <a class="zoom- clearfix" target="_blank" href="http://www.piano-lai.com/item/2941">
                                    <div class="item-container model-left-right padding-8px bg-grey-f5">
                                        ...
                                        <figure class="image-container padding-top-1-4-">
                                            <div class="image-box">
                                                <img data-action="zoom-" src="http://cdn.piano-lai.com/research/common/2023-07-06/64a6242972da41688609833.jpg" alt="Property Image">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 item-col">
                                <a class="zoom- clearfix" target="_blank" href="http://www.piano-lai.com/item/2933">
                                    <div class="item-container model-left-right padding-8px bg-grey-f5">
                                        ...
                                        <figure class="image-container padding-top-1-4-">
                                            <div class="image-box">
                                                <img data-action="zoom-" src="http://cdn.piano-lai.com/research/common/2023-07-06/64a623f557c6a1688609781.jpg" alt="Property Image">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 item-col">
                                <a class="zoom- clearfix" target="_blank" href="http://www.piano-lai.com/item/2932">
                                    <div class="item-container model-left-right padding-8px bg-grey-f5">
                                        ...
                                        <figure class="image-container padding-top-1-4-">
                                            <div class="image-box">
                                                <img data-action="zoom-" src="http://cdn.piano-lai.com/research/common/2023-07-06/64a6240055a131688609792.jpg" alt="Property Image">
