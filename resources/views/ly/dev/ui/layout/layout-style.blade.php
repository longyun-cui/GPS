 ...
 */
    ...
    .module-wrapper.module-bg-orange {
        background: #f54ea2;
    ...
    .module-title.title-white {
        color: #fff;
    }


    .banner-slider-contents .btn { padding:12px 20px; font-size:14px; line-height:24px; }
    .banner-slider-contents .btn.btn-border {
        padding: 10px 18px;
        border: 2px solid #fff;
        color: #fff;
        background: none;
    }
    .banner-slider-contents .btn.btn-border:hover {
        background: #fff;
        color: #333;
    }

    .bg-dark .module-title-row {
        color: #fff;
    }
    .bg-dark .module-subtitle-row {
        font-size:16px;
        color: #ddd;
    }
    .bg-light .module-title-row {
        color: #222;
    }

    .bg-light .module-subtitle-row {
        font-size:16px;
        color: #444;
    }

    .module-body-container .item-piece { padding:4px 8px; }


    .module-video .text-box {
        padding: 12px;
    }
    .module-video .button-col {
        margin: 0;
        padding: 1px;
    }
    .module-video .btn {
