...
@section('head_title')
    {{ $title_text or '待办目录列表' }} - GPS系统 - {{ config('gps.info.info.name') }}
@endsection


@section('header','')
@section('description'){{ $title_text or '待办目录列表' }} - GPS系统 - {{ config('gps.info.info.name') }}@endsection
@section('breadcrumb')
...
{{--            @include(env('TEMPLATE_LY_GPS__ADMIN').'component.product-create')--}}
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "ajax": {
                    'url': "{{ url('/admin/item/todo-menu-list') }}",
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
...
@include(env('TEMPLATE_LY_GPS__ADMIN').'entrance.item.todo-menu-list-script')
