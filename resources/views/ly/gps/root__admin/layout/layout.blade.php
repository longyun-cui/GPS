...
{{--    <link rel="stylesheet" href="{{ asset('/AdminLTE/dist/css/skins/skin-purple-light.min.css') }}">--}}
    ...
    {{--layout-style--}}
    @include(env('TEMPLATE_LY_GPS__ADMIN').'layout.layout-style')
...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_LY_GPS__ADMIN').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_LY_GPS__ADMIN').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_LY_GPS__ADMIN').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_LY_GPS__ADMIN').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_LY_GPS__ADMIN').'layout.control-sidebar')
...
{{--layout-script--}}
@include(env('TEMPLATE_LY_GPS__ADMIN').'layout.layout-script')
