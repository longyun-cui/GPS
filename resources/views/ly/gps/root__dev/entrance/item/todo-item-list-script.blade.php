<script>
    $(function() {
        ...
        $(".main-content").on('click', ".item-create-link", function() {
            ...
            var $url = "/admin/item/todo-item-create?&referrer="+encodeURIComponent(window.location.href);
        ...
        $(".main-content").on('click', ".item-edit-link", function() {
            var $that = $(this);
            var $li = $that.parents('li');
            var $url = "/admin/item/todo-item-edit?id="+$li.attr('data-id')+"&referrer="+encodeURIComponent(window.location.href);
            window.location.href = $url;
            // window.open($url);
        });
        ...
        $(".main-content").on('click', ".item-modal-show-for-detail", function() {
            ...
            {{--    dataType:'json',--}}
            {{--    async:false,--}}
            {{--    url: "{{ url('/admin/item/product-get-html') }}",--}}
            {{--    data: {--}}
...
//            $('input[name=id]').val($that.attr('data-id'));
        ...
        $(".main-content").on('click', ".item-summit-for-detail-inspected", function() {
            ...
            $.post(
                "{{ url('/admin/item/product-inspect') }}",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "todo-inspect",
        ...
        $(".main-content").on('click', ".item-abandon-submit", function() {
            ...
            layer.msg('确定"弃用"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/admin/item/product-abandon') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "todo-abandon",
        ...
        $(".main-content").on('click', ".item-complete-submit", function() {
            ...
            layer.msg('确定"完成"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/admin/item/product-complete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "todo-complete",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-admin-delete-submit", function() {
            ...
            layer.msg('确定"删除"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/admin/item/task-admin-delete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-content").on('click', ".item-admin-restore-submit", function() {
            ...
            layer.msg('确定"恢复"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/admin/item/task-admin-restore') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-content").on('click', ".item-admin-delete-permanently-submit", function() {
            ...
            layer.msg('确定"永久删除"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/admin/item/task-admin-delete-permanently') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-content").on('click', ".item-admin-enable-submit", function() {
            ...
            // });
                    $.post(
                        "{{ url('/admin/item/task-admin-enable') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-content").on('click', ".item-admin-disable-submit", function() {
            ...
            // });
                    $.post(
                        "{{ url('/admin/item/task-admin-disable') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-content").on('click', "#item-submit-for-info-text-set", function() {
            ...
            // });
                    ...
                    $.post(
                        "{{ url('/admin/item/product-info-text-set') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-content").on('click', "#item-submit-for-info-time-set", function() {
            ...
            // });
                    ...
                    $.post(
                        "{{ url('/admin/item/product-info-time-set') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-content").on('click', "#item-submit-for-info-radio-set", function() {
            ...
            // });
                    ...
                    $.post(
                        "{{ url('/admin/item/product-info-radio-set') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
...
//            $('select[name=info-select-set-column-value]').find("option").eq(0).attr("selected","selected");
        ...
        $(".main-content").on('click', "#item-submit-for-info-select-set", function() {
            ...
            // });
                    ...
                    $.post(
                        "{{ url('/admin/item/product-info-select-set') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
...
//                                $('#datatable_ajax_inner').DataTable().ajax.reload(null, false);
        ...
        $(".main-content").on('dblclick', ".modal-show-for-attachment", function() {
            ...
            $.ajax({
                ...
                dataType:'json',
                async:false,
                url: "{{ url('/admin/item/product-get-attachment-html') }}",
                data: {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate:"item-get",
                    product_id: $that.attr('data-id')
        ...
        $(".main-content").on('click', "#item-submit-for-attachment-set", function() {
            ...
            var $index = layer.load(1, {
                ...
                success: function (layer) {
                    ...
                    var options = {
                        url: "{{ url('/admin/item/product-info-attachment-set') }}",
                        type: "post",
                        dataType: "json",
                        // target: "#div2",
                        success: function (data) {
...
//                                $('#datatable_ajax_inner').DataTable().ajax.reload(null, false);
        ...
        $(".main-content").on('click', ".product-attachment-delete-this", function() {
            ...
            layer.msg('确定"删除"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/admin/item/product-info-attachment-delete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "todo-attachment-delete",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            // layer.close(index);
