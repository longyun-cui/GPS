...
{{--    <link rel="stylesheet" href="{{ asset('/AdminLTE/dist/css/skins/skin-purple-light.min.css') }}">--}}
    ...
    <link rel="stylesheet" href="{{ asset('/resource/component//plugins/slick/slick.css') }}">
    <link rel="stylesheet" href="{{ asset('/resource/component//plugins/slick-nav/slicknav.css') }}">

    <link rel="stylesheet" href="{{ asset('/resource/component/plugins/wow/animate.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('/resource/common/css/layout.css') }}" media="all" />
    ...
    <link rel="stylesheet" href="{{ asset('/resource/common/css/animate/hover.css') }}" media="all" />
    <link rel="stylesheet" href="{{ asset('/resource/common/css/animate/3d-rotate.css') }}" media="all" />
    <link rel="stylesheet" href="{{ asset('/resource/common/css/animate/wicked.css') }}" media="all" />

    {{--layout-style--}}
    @include(env('TEMPLATE_LY_GPS__DEV__UI').'layout.layout-style')
...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_LY_GPS__DEV__UI').'layout.main-header')

    {{--main-sidebar--}}
    {{--@include(env('TEMPLATE_LY_GPS__DEV__UI').'layout.main-sidebar')--}}

    {{--main-content--}}
    @include(env('TEMPLATE_LY_GPS__DEV__UI').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_LY_GPS__DEV__UI').'layout.main-footer')

    {{--control-sidebar--}}
    {{--@include(env('TEMPLATE_LY_GPS__DEV__UI').'layout.control-sidebar')--}}
...
<script src="{{ asset('/resource/component/plugins/slick-nav/jquery.slicknav.min.js') }}"></script>
<script src="{{ asset('/resource/component/plugins/slick/slick.min.js') }}"></script>

<script src="{{ asset('/resource/component/plugins/wow/wow.min.js') }}"></script>
<script src="{{ asset('/resource/component/plugins/zoom/zoom.js') }}"></script>
...
<script src="{{ asset('/resource/common/js/theme.js') }}"></script>
...
{{--layout-script--}}
@include(env('TEMPLATE_LY_GPS__DEV__UI').'layout.layout-script')
