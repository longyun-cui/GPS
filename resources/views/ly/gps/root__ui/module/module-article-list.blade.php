    ...
    <div class="container main-container">
        ...
        <div class="module-row module-body-container section-block-container bg-f">
            ...
            <div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 item-col">
                    @include(env('TEMPLATE_LY_GPS__UI').'section.section-article-list-1', ['items'=>$items])
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 item-col">
                    @include(env('TEMPLATE_LY_GPS__UI').'section.section-article-list-2', ['items'=>[]])
                </div>
            </div>
            ...
            <div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 item-col">
                    @include(env('TEMPLATE_LY_GPS__UI').'section.section-article-list-2', ['items'=>$items])
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 item-col">
                    @include(env('TEMPLATE_LY_GPS__UI').'section.section-article-list-2', ['items'=>$items])
                </div>
