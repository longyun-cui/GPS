...
class RZK_Product extends Model
{
    use SoftDeletes;
    //
    protected $table = "rzk_product";
    protected $fillable = [
        ...
        'retail_price', 'wholesale_price', 'wholesale_amount',
...
//    }
    ...
    function updater()
    {
        return $this->belongsTo('App\Models\GH\GH_Admin','updater_id','id');
    }
    // 创作者
    function completer()
    {
        return $this->belongsTo('App\Models\GH\GH_Admin','completer_id','id');
    }
    // 用户
    function user()
    {
    ...
    {
        return $this->belongsToMany('App\Models\GH\GH_Admin','pivot_user_item','item_id','user_id');
    }
