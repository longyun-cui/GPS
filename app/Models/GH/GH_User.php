...
class GH_User extends Authenticatable
{
    use Notifiable;
    use SoftDeletes;
...
//    protected $connection = 'mysql_def';
    ...
    function ext()
    {
        return $this->hasOne('App\Models\GH\GH_UserExt','user_id','id');
    }
    ...
    function parent()
    {
        return $this->belongsTo('App\Models\GH\GH_User','parent_id','id');
    }

    // 名下代理商
    function children()
    {
        return $this->hasMany('App\Models\GH\GH_User','parent_id','id');
    }
    ...
    function pivot_user()
    {
        return $this->belongsToMany('App\Models\GH\GH_User','pivot_user_user','user_1_id','user_2_id')
            ->withPivot(['active','relation_active','type','relation_type'])->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany('App\Models\GH\GH_User','pivot_user_relation','mine_user_id','relation_user_id')
            ->withPivot(['active','relation_active','type','relation_type'])->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany('App\Models\GH\GH_User','pivot_user_relation','relation_user_id','mine_user_id')
            ->withPivot(['active','relation_active','type','relation_type'])->withTimestamps();
    }
