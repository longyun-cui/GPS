<?php
namespace App\Repositories\GH\WEB;
...
class GHWebAdminRepository {
    ...
    public function __construct()
    {
        ...
        $this->view_blade_403 = env('TEMPLATE_GH_WEB_ADMIN').'entrance.errors.403';
        $this->view_blade_404 = env('TEMPLATE_GH_WEB_ADMIN').'entrance.errors.404';
...
//        return redirect('/?'.$parameter_result);
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.index';
    ...
    {
        $this->get_me();
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.errors.404';
    ...
    public function view_my_profile_info_index()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.my-account.my-profile-info-index';
        return view($view_blade)->with($return);
    }
    // 【基本信息】返回-编辑-视图
    public function view_my_profile_info_edit()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.my-account.my-profile-info-edit';
        return view($view_blade)->with($return);
    }
    // 【基本信息】保存数据
...
//            exit($e->getMessage());
    ...
    public function view_my_account_password_change()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.my-account.my-account-password-change';
        return view($view_blade)->with($return);
    }
    // 【密码】保存数据
    ...
    public function view_department_create()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.department.department-edit';
    ...
    public function view_department_edit()
    {
        ...
        else
        {
            ...
            if($mine)
            {
//                if(!in_array($mine->user_category,[1,9,11,88])) return view(env('TEMPLATE_GH_WEB_ADMIN').'errors.404');
            ...
            else return view(env('TEMPLATE_GH_WEB_ADMIN').'errors.404');
        }
    }
    // 【部门管理】保存数据
...
//        if($item->owner_id != $me->id) return response_error([],"该内容不是你的，你不能操作！");
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.item.item-assign-html-for-attachment';
...
//            exit($e->getMessage());
    ...
    public function view_department_list_for_all($post_data)
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.department.department-list-for-all';
        return view($view_blade)->with($return);
    }
    // 【部门管理】返回-列表-数据
...
//        dd($list->toArray());
    ...
    public function view_department_modify_record($post_data)
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.item.car-list-for-all';
        return view($view_blade)->with($return);
    }
    // 【部门管理】【修改记录】返回-列表-数据
...
//        if(!is_numeric($type)) return view(env('TEMPLATE_GH_WEB_ADMIN').'errors.404');
//        if(!in_array($type,[1,2,3,10,11,88])) return view(env('TEMPLATE_GH_WEB_ADMIN').'errors.404');
    ...
    public function view_user_staff_create()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.user.staff-edit';
...
//                $mine->custom = json_decode($mine->custom);
            ...
            else return view(env('TEMPLATE_GH_WEB_ADMIN').'entrance.errors.404');
        }
    }
    // 【用户-员工管理】保存数据
...
//            exit($e->getMessage());
    ...
    public function view_staff_list_for_all($post_data)
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.user.staff-list-for-all';
        return view($view_blade)->with($return);
    }
    // 【用户-员工管理】返回-列表-数据
...
//        dd($list->toArray());
    ...
    public function view_user_client_create()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.user.client-edit';
        return view($view_blade)->with([
            'operate'=>'create',
            'operate_id'=>0,
            'category'=>'item',
    ...
    public function view_user_client_edit()
    {
        ...
        else
        {
            ...
            if($mine)
            {
                if(!in_array($mine->user_category,[0,1,9,11,88])) return view(env('TEMPLATE_GH_WEB_ADMIN').'errors.404');
                $mine->custom = json_decode($mine->custom);
                $mine->custom2 = json_decode($mine->custom2);
                $mine->custom3 = json_decode($mine->custom3);
...
//            exit($e->getMessage());
    ...
    public function view_user_client_list_for_all($post_data)
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.user.client-list-for-all';
        return view($view_blade)->with($return);
    }
    // 【客户管理】返回-列表-数据
...
//        if(!in_array($me->user_type,[0,1,9])) return view(env('TEMPLATE_ROOT_FRONT').'errors.404');
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.item.item-edit';
        return view($view_blade)->with($return);
    }
    // 【内容】返回-编辑-视图
    public function view_item_item_edit($post_data)
    {
        $this->get_me();
        $me = $this->me;
        if(!in_array($me->user_type,[0,1,11,21,22])) return view(env('TEMPLATE_GH_WEB_ADMIN').'errors.404');

        $id = $post_data["item-id"];
        $mine = $this->modelItem->with(['owner'])->find($id);
        if(!$mine) return view(env('TEMPLATE_GH_WEB_ADMIN').'errors.404');
...
//            exit($e->getMessage());
    ...
    public function view_item_project_create()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.item.project-edit';
        return view($view_blade)->with([
            'operate'=>'create',
            'operate_id'=>0,
            'category'=>'item',
...
//            exit($e->getMessage());
    ...
    public function view_item_project_list_for_all($post_data)
    {
        ...
        $return['menu_active_of_car_list_for_all'] = 'active menu-open';
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.item.project-list-for-all';
        return view($view_blade)->with($return);
    }
    // 【车辆管理】返回-列表-数据
...
//        if(!in_array($me->user_type,[0,1,9])) return view(env('TEMPLATE_ROOT_FRONT').'errors.404');
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.item.product-edit-for-import';
        return view($view_blade)->with($return);
    }
    // 【工单管理】保存-导入-数据
...
//        dd($post_data["multiple-excel-file"]);
    ...
    public function view_item_product_create()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.item.product-edit';
        return view($view_blade)->with($return);
    }
    // 【工单管理】返回-编辑-视图
    public function view_item_product_edit()
    {
        ...
        else
        {
            ...
            if($mine)
            {
//                if($mine->deleted_at) return view(env('TEMPLATE_GH_WEB_ADMIN').'entrance.errors.404');
//                else
                {
                    $mine->custom = json_decode($mine->custom);
                    $mine->custom2 = json_decode($mine->custom2);
...
//            $item->trailer = $item->outside_trailer;
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.item.product-info-html';
...
//        if($item->owner_id != $me->id) return response_error([],"该内容不是你的，你不能操作！");
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.item.product-assign-html-for-attachment';
        $html = view($view_blade)->with(['item_list'=>$item->attachment_list])->__toString();
...
//        dd($view_data);
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.item.product-list-for-all';
...
//        dd($list->toArray());
    ...
    public function view_statistic_index()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.statistic.statistic-index';
        return view($view_blade)->with($view_data);
    }
    // 【统计】
    public function view_statistic_user($post_data)
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.statistic.statistic-user';
        return view($view_blade)->with($view_data);
    }
    // 【统计】
    public function view_statistic_item($post_data)
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.statistic.statistic-item';
        return view($view_blade)->with($view_data);
    }
    // 【统计】返回（后台）主页视图
...
//        $return_data['finance_last_month_payout'] = $finance_last_month_payout;
    ...
    public function view_statistic_rank()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.statistic.statistic-rank';
        return view($view_blade)->with($view_data);
    }
...
//        dd($list->toArray());
    ...
    public function view_statistic_rank_by_staff()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.statistic.statistic-rank-by-staff';
        return view($view_blade)->with($view_data);
    }
...
//        dd($list->toArray());
    ...
    public function view_statistic_rank_by_department()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.statistic.statistic-rank-by-department';
        return view($view_blade)->with($view_data);
    }
...
//        dd($list->toArray());
    ...
    public function view_statistic_customer_service()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.statistic.statistic-customer-service';
        return view($view_blade)->with($view_data);
    }
...
//        dd($list->toArray());
    ...
    public function view_statistic_inspector()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.statistic.statistic-inspector';
        return view($view_blade)->with($view_data);
    }
...
//                else $v[$key]->product_average_rate_for_inspected = 0;
    ...
    public function view_statistic_list_for_all($post_data)
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.statistic.statistic-list-for-all';
        return view($view_blade)->with($view_data);
    }
    // 【流量统计】返回-列表-数据
...
//        dd($list->toArray());
    ...
    public function view_statistic_export()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_ADMIN').'entrance.statistic.statistic-export';
        return view($view_blade)->with($view_data);
    }
    // 【数据导出】工单
