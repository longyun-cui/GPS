...
class GHWebDefRepository {
    ...
    public function __construct()
    {
        ...
        $this->view_blade_403 = env('TEMPLATE_GH_WEB_DEF').'entrance.errors.403';
        $this->view_blade_404 = env('TEMPLATE_GH_WEB_DEF').'entrance.errors.404';
...
////        dd($me->toArray());
    ...
    public function view_admin_404()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_DEF').'entrance.errors.404';
    ...
    public function view_product_detail($post_data)
    {
        ...
        $item = GH_Product::find($product_id);

        $return_data['item'] = $item;

        $view_blade = env('TEMPLATE_GH_WEB_DEF').'entrance.product-detail';
        return view($view_blade)->with($return_data);
    }
    ...
    public function view_my_profile_info_index()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_DEF').'entrance.my-account.my-profile-info-index';
    ...
    public function view_my_profile_info_edit()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_DEF').'entrance.my-account.my-profile-info-edit';
        return view($view_blade)->with($return);
    }
    // 【基本信息】保存数据
...
//            exit($e->getMessage());
    ...
    public function view_my_account_password_change()
    {
        ...
        $view_blade = env('TEMPLATE_GH_WEB_DEF').'entrance.my-account.my-account-password-change';
        return view($view_blade)->with($return);
    }
    // 【密码】保存数据
