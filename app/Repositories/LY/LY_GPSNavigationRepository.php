...
class LY_GPSNavigationRepository
{
    ...
    public function __construct()
    {
        ...
        $this->view_blade_403 = env('TEMPLATE_LY_GPS__NAV').'entrance.errors.403';
        $this->view_blade_404 = env('TEMPLATE_LY_GPS__NAV').'entrance.errors.404';
    ...
    // 主页
    public function view_nav_index()
    {
        $this->get_me();
        $me = $this->me;

        $view_blade = env('TEMPLATE_LY_GPS__NAV').'entrance.index';
        return view($view_blade);
    }


    // 返回（后台）主页视图
    public function view_nav_404()
    {
        $this->get_me();
        $view_blade = env('TEMPLATE_LY_GPS__NAV').'entrance.errors.404';
        return view($view_blade);
    }
    ...
    // 主页
    public function view_nav_ui()
    {
        $this->get_me();
        $me = $this->me;

        $view_data['menu_active_of_ui'] = 'active';
        $view_blade = env('TEMPLATE_LY_GPS__NAV').'entrance.ui';
        return view($view_blade);
    }
    // 主页
    public function view_nav_style()
    {
        $this->get_me();
        $me = $this->me;

        $view_data['menu_active_of_style'] = 'active';
        $view_blade = env('TEMPLATE_LY_GPS__NAV').'entrance.style';
    ...
    // template
    public function view_nav_template_list()
    {
        $this->get_me();
        $me = $this->me;

        $view_data['menu_active_of_template_list'] = 'active';
        $view_blade = env('TEMPLATE_LY_GPS__NAV').'entrance.navigation.template-list';
        return view($view_blade)->with($view_data);
    }
    // testing
    public function view_nav_testing_list()
    {
        $this->get_me();
        $me = $this->me;

        $view_data['menu_active_of_testing_list'] = 'active';
        $view_blade = env('TEMPLATE_LY_GPS__NAV').'entrance.navigation.testing-list';
        return view($view_blade)->with($view_data);
    }
    // tool
    public function view_nav_tool_list()
    {
        $this->get_me();
        $me = $this->me;

        $view_data['menu_active_of_tool_list'] = 'active';
        $view_blade = env('TEMPLATE_LY_GPS__NAV').'entrance.navigation.tool-list';
        return view($view_blade)->with($view_data);
    }
    ...
    public function view_my_profile_info_index()
    {
        ...
        $view_blade = env('TEMPLATE_LY_GPS__NAV').'entrance.my-account.my-profile-info-index';
    ...
    public function view_my_profile_info_edit()
    {
        ...
        $view_blade = env('TEMPLATE_LY_GPS__NAV').'entrance.my-account.my-profile-info-edit';
        return view($view_blade)->with($return);
    }
    // 【基本信息】保存数据
...
//            exit($e->getMessage());
    ...
    public function view_my_account_password_change()
    {
        ...
        $view_blade = env('TEMPLATE_LY_GPS__NAV').'entrance.my-account.my-account-password-change';
        return view($view_blade)->with($return);
    }
    // 【密码】保存数据
    ...
    // 【待办事-项目】返回-添加-视图
    public function view_nav_todo_menu_create()
    {
        $this->get_me();
        $me = $this->me;
        ...
        $view_blade = env('TEMPLATE_LY_GPS__NAV').'entrance.item.todo-menu-edit';
        return view($view_blade)->with($return);
    }
    // 【待办事-项目】返回-编辑-视图
    public function view_nav_todo_menu_edit()
    {
        $this->get_me();
        $me = $this->me;
        ...
        else
        {
            ...
            if($mine)
            {
//                if($mine->deleted_at) return view(env('TEMPLATE_LY_GPS__NAV').'entrance.errors.404');
//                else
                {
            ...
            else return view(env('TEMPLATE_LY_GPS__NAV').'entrance.errors.404');
        }
    }
    // 【待办事-项目】保存数据
...
//            exit($e->getMessage());
    ...
    // 【待办事-项目】返回-列表-视图
    public function view_nav_todo_menu_list($post_data)
    {
        $this->get_me();
        $me = $this->me;
        ...
        $view_blade = env('TEMPLATE_LY_GPS__NAV').'entrance.item.todo-menu-list';
        return view($view_blade)->with($view_data);
    }
    // 【待办事-项目】返回-列表-数据
...
//        }
    ...
    // 【待办事-项目】返回-添加-视图
    public function view_nav_todo_item_create()
    {
        $this->get_me();
        $me = $this->me;
        ...
        $view_blade = env('TEMPLATE_LY_GPS__NAV').'entrance.item.todo-item-edit';
        return view($view_blade)->with($return);
    }
    // 【待办事-项目】返回-编辑-视图
    public function view_nav_todo_item_edit()
    {
        $this->get_me();
        $me = $this->me;
...
//            exit($e->getMessage());
    ...
    // 【待办事-项目】返回-列表-视图
    public function view_nav_todo_item_list($post_data)
    {
        $this->get_me();
        $me = $this->me;
...
//        $menu_list = $query->orderBy('updated_at','desc')->get();
        ...
        $view_blade = env('TEMPLATE_LY_GPS__NAV').'entrance.item.todo-item-list';
        return view($view_blade)->with($view_data);
    }
    // 【待办事-项目】返回-列表-数据
...
//        if($item->owner_id != $me->id) return response_error([],"该内容不是你的，你不能操作！");
        ...
        if($data_type == "html")
        {
            $view_blade = env('TEMPLATE_LY_GPS__NAV').'entrance.item.todo-info-html';
