...
use App\Repositories\GH\GH_WWWAdminRepository;

use Response, Auth, Validator, DB, Exception;
use QrCode, Excel;

class GH_WWWAdminController extends Controller
{
    //
    private $repo;
    public function __construct()
    {
        $this->repo = new GH_WWWAdminRepository;
    }
    ...
    public function login()
    {
        ...
        {
            $view_blade = env('TEMPLATE_GH_WWW__ADMIN').'entrance.login';
