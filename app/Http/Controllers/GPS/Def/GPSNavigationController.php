...
class GPSNavigationController extends Controller
{
    //
    private $service;
    private $repo;
    ...
    {
        return view('GPS.default.entrance.navigation.test-list');
    }

    // 工具
    public function tool_list()
    {
        return view('GPS.default.entrance.navigation.tool-list');
    }

    // 模板
    public function template_list()
    {
        return view('GPS.default.entrance.navigation.template-list');
    }
