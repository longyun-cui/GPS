...
namespace App\Http\Controllers\GPS\Dev;
...
use App\Repositories\GPS\Dev\GPSDevUIRepository;

use Response, Auth, Validator, DB, Exception;
use QrCode, Excel;


class GPSDevUIController extends Controller
{
    //
    private $service;
    private $repo;
    ...
    {
        $this->repo = new GPSDevUIRepository();
    }
